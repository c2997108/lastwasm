...
static void insertionSortSimple( unsigned alphSize,
...
static void insertionSort( const PeriodicSpacedSeed& seed,
			   unsigned alphSize,
			   indexT* beg, indexT* end,
...
static void radixSortAlph4( const uchar* textBase, const uchar* textNext,
...
static void radixSort( const uchar* textBase, const uchar* textNext,
		       indexT* beg, indexT* end, indexT depth,
		       unsigned alphSize ){
